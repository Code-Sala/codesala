...
export const portfolioItems = [
  ...
  },
  {
    ...
    title: "Bizupaya",
    category: "E-commerce",
    description: "An advanced inventory management platform designed to streamline product tracking, and order management for growing businesses.",
    image: "/assets/img/portfolio/hti.png",
    technologies: ["Laravel", "VueJs", "PHP", ],
    link: "https://bizupaya.com",
    featured: true,
    icon: Database,
    year: "2024",
